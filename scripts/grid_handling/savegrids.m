...
% Ca 10K celler
% nx = 140; nz = 75; refinementFactorQT = 1.2; refinementFactorT = 1.3; sigdigits = [1, 1];
% ca. 50k celler
% nx = 500; nz = 100; refinementFactorQT = 0.38; refinementFactorT = 0.54; sigdigits = [2, 2];
% ca 100K celler
% nx = 840; nz = 120; refinementFactorQT = 0.25; refinementFactorT = 0.37; sigdigits = [2, 2];
% ca 200K celler
% nx = 1180; nz = 170; refinementFactorQT = 0.17; refinementFactorT = 0.26; sigdigits = [2, 2];
% ca 500K celler
% nx = 1870; nz = 270; refinementFactorQT = 0.103; refinementFactorT = 0.16; sigdigits = [3, 2];
% ca 1M celler
nx = 2640; nz = 380; refinementFactorQT = 0.071; refinementFactorT = 0.112; sigdigits = [3, 3];
